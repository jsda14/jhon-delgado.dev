    ...
    <section id="contacto" className={styles.contact}>
      <Container>
        <div className={styles.contact__header}>
          <span className={styles.contact__eyebrow}>Disponible ahora</span>
          <h2 className={styles.contact__title}>Hablemos</h2>
          <p className={styles.contact__subtitle}>
            ¿Tienes un proyecto en mente? Hablemos de cómo materializarlo con rigor de ingeniería.
          </p>
        </div>
          ...
          {contactMethods.map((method, index) => {
            ...
            return (
              ...
              >
                ...
                <span className={styles['contact-card__label']}>{method.title}</span>
